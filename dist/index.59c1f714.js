...
const newRandomColor = ()=>{
    ...
    sequence1.push(randomColor);
};
async function startGame() {
    newRandomColor();
    alert('Vamos começar, bom jogo!');
    await lightSequence(sequence1);
...
async function lightSequence(sequence) {
...
async function clickColor(event) {
    const clicked = event.target;
    if (clicked.hasAttribute('colorPicker')) {
        const color = clicked.classList.value;
        await lightColor(color);
        clickedSequence.push(color);
        if (clickedSequence.length == sequence1.length) {
...
async function checkSequence() {
    if (JSON.stringify(sequence1) == JSON.stringify(clickedSequence)) {
...
},{"regenerator-runtime/runtime":"1EBPE"}],"1EBPE":[function(require,module,exports) {
/**
...
},{}]},["7SOzi","gK55r"], "gK55r", "parcelRequire477f")
